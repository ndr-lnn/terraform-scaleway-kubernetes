locals {
  talos_backup_s3_scw      = var.talos_backup_s3_scw_url != null ? regex("^(?:https?://)?(?P<bucket>[^.]+)\\.s3\\.(?P<region>[^.]+)\\.scw\\.cloud\\.?$", var.talos_backup_s3_scw_url) : {}
  talos_backup_s3_bucket   = var.talos_backup_s3_scw_url != null ? local.talos_backup_s3_scw.bucket : var.talos_backup_s3_bucket
  talos_backup_s3_region   = var.talos_backup_s3_scw_url != null ? local.talos_backup_s3_scw.region : var.talos_backup_s3_region
  talos_backup_s3_endpoint = var.talos_backup_s3_scw_url != null ? "https://s3.${local.talos_backup_s3_region}.scw.cloud" : var.talos_backup_s3_endpoint
